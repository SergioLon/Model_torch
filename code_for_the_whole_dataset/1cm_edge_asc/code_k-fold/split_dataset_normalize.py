...
from MyOwnDataset_without_normalize_train import MyOwnDataset_without_normalize_train
from MyOwnDataset_without_normalize_val import MyOwnDataset_without_normalize_val
import numpy as np
import torch
from torch.utils.data.sampler import SubsetRandomSampler
def split_dataset_normalize(device,my_path_t,my_path_v,batch_size):
    dataset_train = MyOwnDataset_without_normalize_train(my_path_t)
    dataset_val = MyOwnDataset_without_normalize_val(my_path_v)
