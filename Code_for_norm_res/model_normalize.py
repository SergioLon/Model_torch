...
class Feast_GCN(torch.nn.Module):
    def __init__(self, add_self_loops=True,bias=True,heads=1):
        ...
        self.dropout_4=torch.nn.Dropout2d(p=0.2)
        self.dropout_5=torch.nn.Dropout2d(p=0.2)
        self.dropout_6=torch.nn.Dropout2d(p=0.5)
